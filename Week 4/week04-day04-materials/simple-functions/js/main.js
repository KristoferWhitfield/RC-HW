...
// If the product is greater than 100 add the sum of the last two numbers and console
// log the value. If the product is less that 100, subtract the difference of the last
// two numbers and console log the value. If the product is 100, multiply the first three
// numbers together and alert the remainder of dividing the fourth number

function hard(n1, n2, n3, n4){
  let pro = n1 * n2
  if (pro > 100){
    console.log (pro + n3 + n4)
  }else if (pro < 100){
    console.log (pro - (n3-n4))
  }else{
    alert((n1 * n2 * n3) % n4)
